"""Card de captura para a galeria (layout alinhado ao Figma CaptureGallery)."""
...
class GalleryCaptureCard(GallerySelectableCardMixin, QFrame):
    ...
    def __init__(
        self, capture: Capture, parent=None, *, subtitle: str | None = None
    ) -> None:
        super().__init__(parent)
        self.setObjectName("gallery_capture_card")
        ...
        self._image.setObjectName("gallery_capture_card_image")
        ...
        self._hover_overlay.setObjectName("gallery_capture_card_hover")
        ...
        overlay = QFrame(self)
        overlay.setObjectName("gallery_capture_card_overlay")
        ...
        id_label = QLabel(f"#{capture_id:03d}")
        id_label.setObjectName("gallery_capture_card_filename")
        overlay_layout.addWidget(id_label)

        second_line = (
            subtitle
            if subtitle is not None
            else format_captured_short(capture.captured_at)
        )
        date_label = QLabel(second_line)
        date_label.setObjectName("gallery_capture_card_datetime")
